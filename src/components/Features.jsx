...
function BentoTilt({ children, className = "" }) {
    ...
    const handleMouseMove = (e) => {
        ...
        const tiltX = (relativeY - 0.5) * 35;
        const tiltY = (relativeX - 0.5) * -35;
...
function BentoCard({ src, title, description, isComingSoon }) {
        ...
        <div className={"relative size-full"}>
            ...
            <div className="relative z-10 flex flex-col justify-between p-5 size-full text-blue-50">
                <div>
                    ...
                    {description && (
                        <p className="mt-3 text-xs max-w-64 md:text-base">
                            {description}
                        </p>
                    )}
                </div>
